...
public class App {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // TODO update HQL
            @SuppressWarnings("unchecked")
            List<Flight> flights = session.createQuery("select distinct f from Flight f join f.airplane p where p.model='747' and f.airline<>'Star Alliance'").list();
        ...
        try {
            ...
            Date d=new Date("08/07/2009");
            query.setDate("date", d);
            try {
            	Date t=tf.parse("12:00 PM");
				query.setDate("time", t);
